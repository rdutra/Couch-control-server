...
#define AppName "CouchCTRL Windows Companion"
#define AppPublisher "CouchCTRL"
...
AppPublisherURL=https://couchctrl.app
AppSupportURL=https://couchctrl.app/support
AppUpdatesURL=https://couchctrl.app/download
DefaultDirName={localappdata}\Programs\CouchControl
DefaultGroupName=CouchCTRL
...
Source: "{#PackageRoot}\PRIVACY.md"; DestDir: "{app}"; Flags: ignoreversion
Source: "{#PackageRoot}\SUPPORT.md"; DestDir: "{app}"; Flags: ignoreversion
...
[Icons]
Name: "{group}\CouchCTRL Agent"; Filename: "{app}\agent\CouchControl.Agent.exe"; WorkingDir: "{app}\agent"
Name: "{group}\CouchCTRL CLI"; Filename: "{cmd}"; Parameters: "/k ""{app}\cli\CouchControl.Cli.exe"""; WorkingDir: "{app}\cli"
...
[InstallDelete]
Type: filesandordirs; Name: "{userprograms}\CouchControl"
...
Type: files; Name: "{app}\SUPPORT.md"
