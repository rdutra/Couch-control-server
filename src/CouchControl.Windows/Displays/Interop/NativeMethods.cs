...
namespace CouchControl.Windows.Displays.Interop;
...
internal static class NativeMethods
{
    ...
    [DllImport("user32.dll", SetLastError = true, CharSet = CharSet.Unicode)]
    public static extern int DisplayConfigGetDeviceInfo(
        ref DISPLAYCONFIG_TARGET_PREFERRED_MODE requestPacket);
...
internal struct DISPLAYCONFIG_RATIONAL
{
    ...
    public DISPLAYCONFIG_RATIONAL(uint numerator, uint denominator)
    {
        Numerator = numerator;
...
internal enum DISPLAYCONFIG_ROTATION : uint
{
    ...
    DISPLAYCONFIG_ROTATION_90 = 2,
    DISPLAYCONFIG_ROTATION_180 = 3,
    DISPLAYCONFIG_ROTATION_270 = 4,
...
internal enum DISPLAYCONFIG_SCALING : uint
{
    ...
    DISPLAYCONFIG_SCALING_ASPECTRATIORECTANCED = 4,
